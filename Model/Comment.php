...
class Comment extends Model
{
    ...
    public function getCommentsUser($userId, $status = null)
    {
        $sql = 'SELECT comment.id as id, comment.created_at as created_at, comment.content as content, comment.user_id as user_id, comment.article_id as article_id, user.username, user.picture FROM comment INNER JOIN user ON comment.user_id = user.id WHERE comment.user_id=:id';
